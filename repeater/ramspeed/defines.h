/*
**  miscellaneous definitions related to RAMspeed
**
**  (UNIX release)
**
**
...
**
**
**  Copyright (c) 2002-06 Rhett M. Hollander <rhett@alasir.com>
...
#define MEMSIZE		(80)	/* in Kbytes */
#define MEMPASS		(32)	/* in Mbytes */
