...
#if defined(I386_ASM) || defined(AMD64_ASM)
...
void help(void) {
    ...
    printf("%s\n%s\n",
      "-k  specifies a # of Kbytes per array (default is 1)",
      "-m  specifies a # of kbytes per pass (default is 32)");
...
int ramspeed_main(int argc, char *argv[]) {
    UTL maxblk  = MEMSIZE;
    UTL passize = MEMPASS;
    U32 bid = 0;
    /*U32 bnum = 1;*/
